...
impl Matrix {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        // A visible line rather than an HTML comment: this page is rendered by
        // Docusaurus, whose MDX parser rejects `<!-- … -->`. A plain emphasis
        // line renders correctly on GitHub and on the site, and warns the
        // reader as well as the editor.
        out.push_str(
            "_Generated by `bin/gen-matrix` — do not edit. `bin/check-matrix` fails if this \
             file drifts from the conformance specs._\n\n",
        );
        out.push_str(
